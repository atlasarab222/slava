  ...
  return (
    <div id="slava-dent-container" className="min-h-screen w-full bg-[#121212] text-white font-sans flex overflow-hidden selection:bg-zinc-800 selection:text-white">
      ...
      <div className="flex-1 lg:w-[42%] xl:w-[38%] h-screen flex items-center justify-center bg-[#121212]">
        <div id="mobile-device-shell" className="w-full max-w-[340px] h-screen md:h-[780px] bg-[#121212] md:rounded-[48px] md:  flex flex-col overflow-hidden relative border-0 md:border md:border-zinc-800">
            ...
            <AnimatePresence mode="wait">
              ...
              {view === "dashboard" && user && (
                ...
                >
                  ...
                  <div className="px-2.5 py-2.5 bg-[#121212] border-b border-zinc-800 flex justify-between items-center gap-1.5 sticky top-0 z-15 select-none shrink-0  ">
                    {/* Site name left */}
                    <div className="flex items-center gap-1 shrink-0">
                      <div className="w-5 h-5 rounded-2xl border border-zinc-800 bg-zinc-800 flex items-center justify-center">
                    ...
                    <div className="flex-1 max-w-[155px] relative">
                      ...
                      <input
                        ...
                        placeholder="search"
                        className="w-full bg-[#1A1A1A] border border-zinc-800 rounded-xl border border-zinc-800 rounded-2xl py-1 pl-7 pr-3 text-[10px] text-white placeholder:text-white focus:outline-hidden focus:border-zinc-800 transition-all font-mono"
                      />
                      
                      {headerShowDropdown && searchQuery.trim().length > 0 && (
                        <div className="absolute left-0 right-0 top-full mt-1.5 max-h-52 overflow-y-auto bg-[#121212] border border-zinc-800 rounded-2xl   z-50 divide-y divide-zinc-900 scrollbar-thin">
                          {(() => {
                    ...
                    <button
                        onClick={() => setLang(lang === 'ar' ? 'en' : 'ar')}
                        className="p-1.5 bg-[#121212] hover:bg-zinc-800 border border-zinc-800 text-white  rounded-2xl transition-all shrink-0 flex items-center justify-center cursor-pointer active:scale-95 text-[9px] font-mono font-bold w-7 h-7"
                    >
                        {lang === 'ar' ? 'EN' : 'AR'}
                    </button>
                    ...
                    <button
                      ...
                      className="p-1.5 bg-[#121212] hover:bg-zinc-800 border border-zinc-800 text-white  rounded-2xl transition-all shrink-0 flex items-center justify-center cursor-pointer active:scale-95"
                  ...
                  <div className="flex items-center gap-1 px-2.5 py-1.5 border-b border-zinc-800 bg-[#151517] overflow-x-auto scrollbar-none sticky top-[44px] z-10 shrink-0">
                    {[
